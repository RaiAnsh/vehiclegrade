  ...
  return (
    <section className="relative flex min-h-[85vh] items-center justify-center px-6">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        >
          Rule-based deal intelligence &middot; No machine learning
        </motion.div>
        ...
        >
          Marketplace Intelligence for{" "}
          <span className="accent-gradient-text">Smarter Buyers</span>
        </motion.h1>
        ...
        >
          Analyze listings, estimate fair market value, negotiate smarter, and
          discover the best deals before anyone else.
        </motion.p>
