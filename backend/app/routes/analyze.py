...
from app.models import Listing, VehicleMake, VehicleModel
from app.services.reference_resolver import resolve_generation, resolve_location, resolve_make, resolve_model, resolve_trim
...
def analyze_listing():
    ...
    trim = resolve_trim(generation, payload.get("trim"))
    location = resolve_location(payload.get("location"))
